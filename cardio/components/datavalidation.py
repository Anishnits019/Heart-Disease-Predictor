from cardio.entity.config_entity import DataValidationConfig
from cardio.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
...
from cardio.constant.training_pipeline import DATA_VALIDATION_THRESHOLD
from cardio.utils.main_utils.utils import write_yaml_file
from cardio.utils.main_utils.utils import read_yaml_file
...
class DataValidation:
    ...
    cardioe from a data warehouse, Kafka, S3 partitioned by date, etc.
        """
